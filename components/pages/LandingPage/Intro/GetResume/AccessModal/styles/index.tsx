...
export const StyledModal = styled(Modal as unknown as ComponentType<any>)`
...
export const SubmitArrow = styled.button<SubmitArrowProps>(
  ({ isSubmitting }) => [
...
export const SuggestionButton = tw.button`inline outline-none focus:outline-none font-normal border-b-2 text-dark-primary border-dark-primary dark:border-primary border-dashed
hover:(border-dark-200 text-dark-200)
dark:(text-primary hover:(border-light-primary text-light-primary))
`;
